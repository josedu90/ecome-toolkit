<?php
/**
 * Widget API: Ecome_Custom_Menu_Widget class
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see WP_Widget
 */
class Ecome_Custom_Menu_Widget extends WP_Widget
{
	/**
	...
	public function __construct()
	{
		...
		parent::__construct( 'ecome_nav_menu', __( 'Ecome: Custom Menu' ), $widget_ops );
	}
 ...
 * @since 2.3.0
 */
function Ecome_Custom_Menu_Widget()
{
	register_widget( 'Ecome_Custom_Menu_Widget' );
}

add_action( 'widgets_init', 'Ecome_Custom_Menu_Widget' );