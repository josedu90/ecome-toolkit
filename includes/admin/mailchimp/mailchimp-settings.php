...
if ( !class_exists( 'Toolkit_MailChimp_Settings' ) ) {
	class Toolkit_MailChimp_Settings
	{
		...
		public function add_plugin_page()
		{
			...
			add_submenu_page( 'ecome_menu', __( 'MailChimp Settings', 'ecome-toolkit' ), __( 'MailChimp', 'ecome-toolkit' ), 'manage_options', 'mailchimp-settings', array( $this, 'create_admin_page' ) );
		}
		...
		public function create_admin_page()
		{
			?>
            <div class="wrap">
                <h2><?php _e( 'Mail Chimp Settings', 'ecome-toolkit' ); ?></h2>
		...
		public function page_init()
		{
			...
			add_settings_section(
				...
				__( 'Settings', 'ecome-toolkit' ), // Title
				array( $this, 'print_section_info' ), // Callback
				'mailchimp-settings' // Page
			);
			add_settings_field(
				'api_key', // ID
				__( 'Mail Chimp API Key', 'ecome-toolkit' ), // Title
			...
			if ( isset ( $api_key ) && !empty ( $api_key ) ) {
				add_settings_field(
					'email_lists', // ID
					__( 'Email Lists', 'ecome-toolkit' ), // Title
				...
				add_settings_field(
					'success_message', // ID
					__( 'Success message', 'ecome-toolkit' ), // Title
		...
		public function api_key_callback()
		{
			...
			printf(
				...
				__( 'Enter your mail Chimp API key to enable a newsletter signup option with the registration form.', 'ecome-toolkit' )
			);
			printf( wp_kses( __( '<a href="%s" target="_blank">Click here to get your Mailchimp API key</a>', 'ecome-toolkit' ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ), 'https://admin.mailchimp.com/account/api' );
		}
