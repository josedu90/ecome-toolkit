...
if ( !class_exists( 'ECOME_IMPORTER' ) ) {
	class ECOME_IMPORTER
	{
		...
		public function __construct()
		{
			...
			$registed_menu = array(
				'primary'        => esc_html__( 'Primary Menu', 'ecome-toolkit' ),
				'gradient_menu'  => esc_html__( 'Gradient Menu', 'ecome-toolkit' ),
				'vertical_menu'  => esc_html__( 'Vertical Menu', 'ecome-toolkit' ),
				'top_left_menu'  => esc_html__( 'Top Left Menu', 'ecome-toolkit' ),
				'top_right_menu' => esc_html__( 'Top Right Menu', 'ecome-toolkit' ),
			);
			$menu_location = array(
			...
			$data_filter   = array(
				'data_demos'    => array(
					array(
						'name'           => esc_html__( 'Import Demo', 'ecome-toolkit' ),
						'slug'           => 'home-01',
						'menus'          => $registed_menu,
						'homepage'       => 'Home 01',
						'blogpage'       => 'Blog',
						'preview'        => get_theme_file_uri( 'screenshot.jpg' ),
						'demo_link'      => 'https://ecome.namcrafted.com',
						'menu_locations' => $menu_location,
						'theme_option'   => ECOME_IMPORTER_DIR . '/data/theme-options.txt',
						'content_path'   => ECOME_IMPORTER_DIR . '/data/content.xml',
						'widget_path'    => ECOME_IMPORTER_DIR . '/data/widgets.wie',
						'revslider_path' => ECOME_IMPORTER_DIR . '/data/revsliders/',
					),
				),
				'item_import'   => array(
			...
			$import_data   = apply_filters( 'ecome_data_import', $data_filter );
			// SET DATA DEMOS
		...
		{
			$this->define( 'ECOME_IMPORTER_DIR', plugin_dir_path( __FILE__ ) );
			$this->define( 'ECOME_IMPORTER_URI', plugin_dir_url( __FILE__ ) );
		}
		...
		{
			if ( $hook_suffix == 'toplevel_page_ecome_menu' ) {
				wp_enqueue_style( 'thickbox' );
				wp_enqueue_style( 'kt-importer-style', ECOME_IMPORTER_URI . '/assets/circle.css' );
				wp_enqueue_style( 'kt-importer-circle', ECOME_IMPORTER_URI . '/assets/import.css' );
				wp_enqueue_script( 'thickbox' );
				wp_enqueue_script( 'kt-importer-script', ECOME_IMPORTER_URI . '/assets/import.js', array( 'jquery' ), false );
			}
		}
            ...
            <div class="kt-importer-wrapper">
                ...
                <div class="note">
                    ...
                    <p>Please ensure you have already installed and
                        activated Ecome Toolkit, WooCommerce, Visual
			...
			if ( class_exists( 'WooCommerce' ) ) {
				...
				if ( current_user_can( 'administrator' ) ) {
					$attributes = array(
						...
						array(
							'attribute_label'   => 'Tivi Details',
							'attribute_name'    => 'tivi_details',
							'attribute_type'    => 'select', // text, box_style, select
							'attribute_orderby' => 'menu_order',
							'attribute_public'  => '0',
						),
					);
					$attributes = apply_filters( 'ecome_import_wooCommerce_attributes', $attributes );
