...
class Ecome_Mapper {
	 ...
	 * @var  string
	 */
	protected static $prefix = 'Ecome_Mapper_';
	...
	public static function initialize() {
		...
		Ecome_Mapper_Post_Type::initialize();

		// Initialize shortcode.
		Ecome_Mapper_Shortcode::initialize();
		...
		add_image_size( 'ecome-wc-thumbnail', $size_thumb['width'], $size_thumb['height'], $size_thumb['crop'] );
	}
	...
	public static function autoload( $class_name ) {
		...
		$base = ECOME_TOOLKIT_PATH . '/includes/mapper/includes/';
...
$ecome_papper = new  Ecome_Mapper();
$ecome_papper::initialize();
